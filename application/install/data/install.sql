/*
 ...
 Source Schema         : twothink

 Target Server Type    : MySQL
 Target Server Version : 50637
 File Encoding         : 65001

 Date: 22/01/2018 15:13:18
*/
...
CREATE TABLE `geek_action`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '权限名称',
  `moudle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '模块',
  `controller` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '控制器',
  `function` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '方法',
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '代码',
  `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '权限说明',
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 135 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作表' ROW_FORMAT = Compact;
...
CREATE TABLE `geek_action_log`  (
  ...
  `moudle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `geek_admin_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台用户角色表' ROW_FORMAT = Compact;
...
CREATE TABLE `geek_config`  (
  ...
  `enum` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '枚举型设置',
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of geek_config
-- ----------------------------
INSERT INTO `geek_config` VALUES (40, 'TITLE', 1, '网站标题', 2, '', 0, 'TWOTHINK网站管理系统', 1, '', '', '2017-03-24 23:03:54', '2017-03-24 23:03:54');
INSERT INTO `geek_config` VALUES (41, 'DESCRIBE', 6, '网站描述', 2, '', 0, 'TWOTHINK网站管理系统', 2, '', '', '2017-03-24 23:05:16', '2017-03-24 23:05:16');
INSERT INTO `geek_config` VALUES (42, 'KEYWORD', 1, '网站关键字', 2, '', 0, 'TWOTHINK网站管理系统,TWOTHINK', 3, '', '', '2017-03-24 23:06:29', '2017-03-24 23:06:29');
INSERT INTO `geek_config` VALUES (43, 'RECORD_NUMBER', 1, '网站备案号', 2, '', 0, '湘ICP备15015131号 - 2', 5, '', '', '2017-03-24 23:07:32', '2017-03-24 23:07:32');
INSERT INTO `geek_config` VALUES (44, 'DATA_BACKUP_PATH', 1, '数据库备份根路径', 2, '', 0, '../data/', 0, '', '', '2017-04-08 17:03:46', '2017-04-08 17:03:48');
INSERT INTO `geek_config` VALUES (45, 'DATA_BACKUP_PART_SIZE', 1, '数据库备份卷大小', 2, '', 0, '20971520', 0, '', '', '2017-04-08 18:57:06', '2017-04-08 18:57:08');
INSERT INTO `geek_config` VALUES (46, 'DATA_BACKUP_COMPRESS', 1, '数据库备份文件是否启用压缩', 2, '0:不压缩\r\n1:启用压缩', 0, '1', 0, '', '', '2017-04-08 18:57:10', '2017-04-08 18:57:13');
INSERT INTO `geek_config` VALUES (47, 'DATA_BACKUP_COMPRESS_LEVEL', 1, '数据库备份文件压缩级别', 2, '1:普通\r\n4:一般\r\n9:最高', 0, '9', 0, '', '', '2017-04-08 18:58:22', '2017-04-08 18:58:24');
INSERT INTO `geek_config` VALUES (48, 'GUANBIZHANDI', 1, '关闭站点', 3, '', 0, '0', 0, '', '', '2017-04-08 21:26:20', '2017-04-08 21:26:22');
INSERT INTO `geek_config` VALUES (49, 'GUANBIYUANYIN', 6, '关闭原因', 3, '', 0, '系统已关闭，请联系管理员', 0, '', '', '2017-04-08 21:27:27', '2017-04-08 21:27:30');
...
CREATE TABLE `geek_member`  (
  ...
  `sex` tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '性别,0未设置,1男,2女',
  `birthday` date NULL DEFAULT NULL COMMENT '生日',
  `qq` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT 'qq号',
  `login` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '登录次数',
  `reg_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '注册IP',
  `reg_time` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '注册时间',
  `last_login_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '最后登录IP',
  `last_login_time` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '最后登录时间',
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '会员状态,1启用,0禁用',
  `signature` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '个性签名',
  PRIMARY KEY (`uid`) USING BTREE,
  INDEX `status`(`status`) USING BTREE,
  INDEX `name`(`nickname`(191)) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户资料表' ROW_FORMAT = Compact;
...
CREATE TABLE `geek_menu`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '菜单说明',
  `is_dev` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否仅开发者模式可见,0所有模式都可见,1仅开发者模式可见',
  `privilege_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '关联权限代码',
  `icon` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '导航图标',
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid`(`pid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10139 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of geek_menu
-- ----------------------------
INSERT INTO `geek_menu` VALUES (10071, '系统管理', 0, 1, '', 0, '', 0, 'System', 'fa fa-cog', '2017-02-05 09:03:15', '2017-02-06 08:59:21');
...
INSERT INTO `geek_menu` VALUES (10076, '用户组管理', 10073, 1, '/admin/AdminRole/index', 0, '', 0, 'admin.AdminRole.index', 'fa fa-cog', '2017-02-05 19:32:44', '2017-02-07 11:37:51');
INSERT INTO `geek_menu` VALUES (10077, '系统配置', 10071, 2, '/admin/System/index', 0, '', 0, 'admin.System.index', 'fa fa-cog', '2017-02-05 20:51:27', '2017-02-06 09:00:58');
...
CREATE TABLE `geek_ucenter_admin`  (
  ...
  `salt` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '用户状态:\'-1删除,0禁用,1启用\'',
  `reg_ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '注册IP',
  `last_login_ip` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '最后登录IP',
...
CREATE TABLE `geek_ucenter_member`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户ID',
  `username` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '用户名',
  `password` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '密码',
  `salt` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `email` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '用户邮箱',
  `mobile` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '用户手机',
  `reg_ip` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '注册IP',
  `created_at` datetime(0) NULL DEFAULT NULL COMMENT '注册时间',
  `updated_at` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网站用户表' ROW_FORMAT = Compact;
